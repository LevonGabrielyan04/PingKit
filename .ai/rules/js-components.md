...
http/Errors.vue renders Pagination with current-page/last-page from pagination meta, pageHref from usePageHref(errors), aria-label, and test-id="http-check-logs". Do not inline Previous/Next/page-number markup or pageHref in http/Errors.vue.
