...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('alter table `http_check_logs` add constraint `http_check_logs_error_message_max_length` check (`error_message` is null or char_length(`error_message`) <= 3000)');
